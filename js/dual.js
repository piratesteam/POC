...
function update() {
    ...
    if (keyboard.pressed("W")){
         sea_sound.play();
         finalship.translateZ(-moveDistance*1.2);
    ...
    if (keyboard.pressed("up")){
         sea_sound.play();
         finalship2.translateZ(-moveDistance*1.2);
    }
    ...
    var relativeCameraOffset2 = new THREE.Vector3(30, 10, 90);
    ...
    //Bomb Velocity 
    if (shootbomb) 
    shootbomb.translateX(moveDistance * 12);

    //Bomb2 Velocity
    if (shootbomb2)
    shootbomb2.translateX(-moveDistance * 12);
